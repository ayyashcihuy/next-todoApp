...
export default function Form() {
    ...
    function closeToggle(stats: boolean): void {
        ...
        <div id="authentication-modal" aria-hidden="true" className="flex fixed justify-center place-items-center top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div className="relative w-full max-w-md max-h-full">
                <div className="relative bg-white rounded-lg shadow">
                    <button onClick={() => closeToggle(false)} type="button" className="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:text-gray-800 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center hover:bg-gray-800" data-modal-hide="authentication-modal">
